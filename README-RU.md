...
* **[Скачать ZIP-архив проекта (Жми сюда)](https://github.com/TruthCode-hash/architect-of-meanings/releases/download/v1.0.0/architect-v1.0.0.zip)** и распакуйте его в любую удобную папку (например, `C:\Architect` для Windows).
